...
print()
NFQ, AFQ = QuitarInterseccion(NF, AFutbol, NR, AResultado)
print('Equipo de futbol sin integrantes repetidos')
EscribirArreglo(NFQ, AFQ)

# -- Mostrar equipo de basquet sin los integrantes que se repiten
print()
NBQ, ABQ = QuitarInterseccion(NB, ABasket, NR, AResultado)
print('Equipo de futbol sin integrantes repetidos')
EscribirArreglo(NBQ, ABQ)
